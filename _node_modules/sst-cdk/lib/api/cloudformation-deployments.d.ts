...
export declare class CloudFormationDeployments {
    ...
    destroyStack(options: DestroyStackOptions): Promise<any>;
    stackExists(options: StackExistsOptions): Promise<boolean>;
    describeStackEvents(stack: cxapi.CloudFormationStackArtifact, stackName: string): Promise<import("aws-sdk/clients/cloudformation").StackEvents | undefined>;
    /**
