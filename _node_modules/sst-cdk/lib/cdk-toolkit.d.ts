...
export declare class CdkToolkit {
    ...
    deploy(options: DeployOptions): Promise<any>;
    destroy(options: DestroyOptions): Promise<any>;
     ...
     */
    synth(stackNames: string[], exclusively: boolean, quiet: boolean, options?: {
        nonCli?: boolean;
    }): Promise<any>;
    /**
     ...
     */
    bootstrap(environmentSpecs: string[], bootstrapper: Bootstrapper, options: BootstrapEnvironmentOptions, nonCli?: boolean, cdkOutputPath?: string): Promise<any>;
    private selectStacksForList;
    private selectStacksForDeploy;
    private selectStacksForDiff;
    private selectStacksForDestroy;
    private selectStacksForDestroyAll;
    /**
